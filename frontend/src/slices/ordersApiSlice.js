...
export const { useCreateOrderMutation, useGetOrderQuery, usePayOrderMutation, useDeliverOrderMutation, useGetPayPalClientIdQuery, useGetMyOrdersQuery, useGetOrdersQuery} = ordersApiSlice;